...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_allBins(AnomalousCouplingModel):
...
#        self.lepchannels  = ['ch1','ch2']
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        print '=========================> reading %s/signal_WV_%s_allBins.root'%(basepath,lepchannel) 
        filename = '%s/signal_WV_%s_allBins.root'%(basepath,lepchannel)  

              
#        f = r.TFile('%s/mu_boosted.root'%basepath,'READ')
        print '=========================> reading %s/%s_boosted_allBins.root'%(basepath,lepchannel) 
        f = r.TFile('%s/%s_boosted_allBins.root'%(basepath,lepchannel),'READ')
...
dkglZModel_wz_allBins = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_allBins('dkglZ')
dg1lZModel_wz_allBins = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_allBins('dg1lZ')
dkgdg1Model_wz_allBins = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_allBins('dkgdg1')
