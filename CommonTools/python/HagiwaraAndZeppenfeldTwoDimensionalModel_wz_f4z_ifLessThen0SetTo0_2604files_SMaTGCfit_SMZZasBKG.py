...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f4z_ifLessThen0SetTo0_2604files_SMaTGCfit_SMZZasBKG(AnomalousCouplingModel):
...
#                                      'lZ' :['-0.015','0.015']     }
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        print '\t\t *********************** Hagiwara reading: %s/signal_WV_%s_f4z_ifLessThen0SetTo0_2604Files_SMaTGCfit.root'%(basepath,lepchannel)  
...
dkglZModel_wz_f4z_ifLessThen0SetTo0_2604files_SMaTGCfit_SMZZasBKG = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f4z_ifLessThen0SetTo0_2604files_SMaTGCfit_SMZZasBKG('dkglZ')
dg1lZModel_wz_f4z_ifLessThen0SetTo0_2604files_SMaTGCfit_SMZZasBKG = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f4z_ifLessThen0SetTo0_2604files_SMaTGCfit_SMZZasBKG('dg1lZ')
dkgdg1Model_wz_f4z_ifLessThen0SetTo0_2604files_SMaTGCfit_SMZZasBKG = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f4z_ifLessThen0SetTo0_2604files_SMaTGCfit_SMZZasBKG('dkgdg1')
