...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_ZZ_4l_8TeV_f4(AnomalousCouplingModel):
...
#        self.lepchannels  = ['ch1','ch2']
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        filename = '%s/signal_%s_ZZ_4l_8TeV_f4.root'%(basepath,lepchannel)  
...
dkglZModel_wz_ZZ_4l_8TeV_f4 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_ZZ_4l_8TeV_f4('dkglZ')
dg1lZModel_wz_ZZ_4l_8TeV_f4 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_ZZ_4l_8TeV_f4('dg1lZ')
dkgdg1Model_wz_ZZ_4l_8TeV_f4 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_ZZ_4l_8TeV_f4('dkgdg1')
