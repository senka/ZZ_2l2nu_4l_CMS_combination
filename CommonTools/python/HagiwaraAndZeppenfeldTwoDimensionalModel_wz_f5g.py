...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g(AnomalousCouplingModel):
...
#        self.lepchannels  = ['ch1','ch2']
        ...
        self.mode      = mode
        self.anomCoupSearchWindows = {'dkg':['-0.007','0.007'],
                                      'dg1':['-0.007','0.007'],
                                      'lZ' :['-0.007','0.007']     }
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        print '\t\t *********************** Hagiwara reading: %s/signal_WV_%s_f5g.root'%(basepath,lepchannel)  
        filename = '%s/signal_WV_%s_f5g.root'%(basepath,lepchannel)  
...
dkglZModel_wz_f5g = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g('dkglZ')
dg1lZModel_wz_f5g = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g('dg1lZ')
dkgdg1Model_wz_f5g = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g('dkgdg1')
