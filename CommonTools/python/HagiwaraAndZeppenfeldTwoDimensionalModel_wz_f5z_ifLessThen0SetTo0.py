...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z_ifLessThen0SetTo0(AnomalousCouplingModel):
...
#                                      'lZ' :['-0.015','0.015']     }
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        print '\t\t *********************** Hagiwara reading: %s/signal_WV_%s_f5z_ifLessThen0SetTo0.root'%(basepath,lepchannel)  
        filename = '%s/signal_WV_%s_f5z_ifLessThen0SetTo0.root'%(basepath,lepchannel)  
...
dkglZModel_wz_f5z_ifLessThen0SetTo0 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z_ifLessThen0SetTo0('dkglZ')
dg1lZModel_wz_f5z_ifLessThen0SetTo0 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z_ifLessThen0SetTo0('dg1lZ')
dkgdg1Model_wz_f5z_ifLessThen0SetTo0 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z_ifLessThen0SetTo0('dkgdg1')
