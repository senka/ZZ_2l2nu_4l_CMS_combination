...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f4g(AnomalousCouplingModel):
...
#        self.lepchannels  = ['ch1','ch2']
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        print '\t\t *********************** Hagiwara reading: %s/signal_WV_%s_f4g.root'%(basepath,lepchannel)  
        filename = '%s/signal_WV_%s_f4g.root'%(basepath,lepchannel)  
...
dkglZModel_wz_f4g = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f4g('dkglZ')
dg1lZModel_wz_f4g = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f4g('dg1lZ')
dkgdg1Model_wz_f4g = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f4g('dkgdg1')
