...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z_ifLessThen0SetTo0_2604files_SMaTGCfit(AnomalousCouplingModel):
...
#                                      'lZ' :['-0.015','0.015']     }
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        print '\t\t *********************** Hagiwara reading: %s/signal_WV_%s_f5z_ifLessThen0SetTo0_2604Files_SMaTGCfit.root'%(basepath,lepchannel)  
...
dkglZModel_wz_f5z_ifLessThen0SetTo0_2604files_SMaTGCfit = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z_ifLessThen0SetTo0_2604files_SMaTGCfit('dkglZ')
dg1lZModel_wz_f5z_ifLessThen0SetTo0_2604files_SMaTGCfit = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z_ifLessThen0SetTo0_2604files_SMaTGCfit('dg1lZ')
dkgdg1Model_wz_f5z_ifLessThen0SetTo0_2604files_SMaTGCfit = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z_ifLessThen0SetTo0_2604files_SMaTGCfit('dkgdg1')
