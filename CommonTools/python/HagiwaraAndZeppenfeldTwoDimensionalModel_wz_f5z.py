...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z(AnomalousCouplingModel):
...
#        self.lepchannels  = ['ch1','ch2']
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        print '\t\t *********************** Hagiwara reading: %s/signal_WV_%s_f5z.root'%(basepath,lepchannel)  
        filename = '%s/signal_WV_%s_f5z.root'%(basepath,lepchannel)  
...
dkglZModel_wz_f5z = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z('dkglZ')
dg1lZModel_wz_f5z = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z('dg1lZ')
dkgdg1Model_wz_f5z = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5z('dkgdg1')
