...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_CLsUnc(AnomalousCouplingModel):
...
#                                      'lZ' :['-0.015','0.015']     }
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        if ('ch' in lepchannel):
            print 'reading %s/signal_WV_%s_f5g_ifLessThen1SetTo1_2604Files_SMaTGCfit.root for %s'%(basepath,lepchannel,lepchannel)
            filename = '%s/signal_WV_%s_f5g_ifLessThen1SetTo1_2604Files_SMaTGCfit.root'%(basepath,lepchannel)
        else:
            print 'reading %s/signal_WV_%s_f5g_ifLessThen0SetTo0_2604Files_SMaTGCfit.root for %s'%(basepath,lepchannel,lepchannel)
            filename = '%s/signal_WV_%s_f5g_ifLessThen0SetTo0_2604Files_SMaTGCfit.root'%(basepath,lepchannel)

        print '\t\t *********************** Hagiwara reading: %s/signal_WV_%s_f5g_ifLessThen1SetTo1_2604Files_SMaTGCfit.root'%(basepath,lepchannel)  
#        filename = '%s/signal_WV_%s_f5g_ifLessThen1SetTo1_2604Files_SMaTGCfit.root'%(basepath,lepchannel)  
...
dkglZModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_CLsUnc = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_CLsUnc('dkglZ')
dg1lZModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_CLsUnc = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_CLsUnc('dg1lZ')
dkgdg1Model_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_CLsUnc = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_CLsUnc('dkgdg1')
