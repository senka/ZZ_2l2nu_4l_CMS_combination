...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_UncAsSM(AnomalousCouplingModel):
...
#        f = r.TFile('%s/mu_boosted.root'%basepath,'READ')
        print '\t\t *********************** Hagiwara reading: %s/%s_assm_boosted.root'%(basepath,lepchannel)
        print '\t\t *********************** Hagiwara reading: %s/signal_WV_%s_f5g_ifLessThen1SetTo1_2604Files_SMaTGCfit.root'%(basepath,lepchannel)
        f = r.TFile('%s/%s_assm_boosted.root'%(basepath,lepchannel),'READ')
...
dkglZModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_UncAsSM = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_UncAsSM('dkglZ')
dg1lZModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_UncAsSM = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_UncAsSM('dg1lZ')
dkgdg1Model_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_UncAsSM = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_f5g_ifLessThen1SetTo1_2604files_SMaTGCfit_SMZZasBKG_UncAsSM('dkgdg1')
