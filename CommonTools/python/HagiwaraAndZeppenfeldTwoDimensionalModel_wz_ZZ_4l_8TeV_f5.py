...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_ZZ_4l_8TeV_f5(AnomalousCouplingModel):
...
#        self.lepchannels  = ['ch1','ch2']
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        filename = '%s/signal_%s_ZZ_4l_8TeV_f5.root'%(basepath,lepchannel)  

              
#        f = r.TFile('%s/mu_boosted.root'%basepath,'READ')
        f = r.TFile('%s/%s_ZZ_4l_8TeV_boosted.root'%(basepath,lepchannel),'READ')
...
dkglZModel_wz_ZZ_4l_8TeV_f5 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_ZZ_4l_8TeV_f5('dkglZ')
dg1lZModel_wz_ZZ_4l_8TeV_f5 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_ZZ_4l_8TeV_f5('dg1lZ')
dkgdg1Model_wz_ZZ_4l_8TeV_f5 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_ZZ_4l_8TeV_f5('dkgdg1')
