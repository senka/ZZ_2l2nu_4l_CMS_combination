void checkWS_scale(TString file_name){
  ...
  data_histo->Draw("pesame");
   ...
   drawCaption(0.2,0.9, "Scale signal uncertainty");
   c3_SMandbkg->SaveAs("plot_scaleUnc.pdf");
   c3_SMandbkg->SaveAs("plot_scaleUnc.root");
   
   gPad->SetLogy();
   c3_SMandbkg->SaveAs("plot_scaleUnc_log.pdf");
   c3_SMandbkg->SaveAs("plot_scaleUnc_log.root");
