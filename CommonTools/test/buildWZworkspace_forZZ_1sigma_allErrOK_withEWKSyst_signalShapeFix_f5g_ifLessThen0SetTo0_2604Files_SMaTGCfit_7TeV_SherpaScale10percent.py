...
# set sherpa and scale uncertainty to 10%
    if (codename=="ch9"):
        card += """       
Sherpa           lnN     1.1/0.9          """.format(codename=codename,norm_sig_sm=norm_sig_sm,norm_bkg=norm_bkg[i],norm_obs=norm_obs)
    else:
        card += """       
Sherpa           lnN     0.9/1.1          """.format(codename=codename,norm_sig_sm=norm_sig_sm,norm_bkg=norm_bkg[i],norm_obs=norm_obs)
    ...
    card += """       
Scale           lnN     0.9/1.1          """.format(codename=codename,norm_sig_sm=norm_sig_sm,norm_bkg=norm_bkg[i],norm_obs=norm_obs)
