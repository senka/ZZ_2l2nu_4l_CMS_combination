...
lumi_7TeV       \t    lnN \t    1.022             """
    ...
    if (codename=="ch7" or codename=="ch8" or codename=="ch10"):
        sherpa_down_=1.-(1.-sherpa_down[k])*3.
        sherpa_up_=(sherpa_up[k]-1.)*3.+1.
        scale_down_=1.-(1.-scale_down[k])*3.
        scale_up_=(scale_up[k]-1.)*3.+1.
    elif (codename=="ch9"):
#        sherpa_down_=1.-(1.-sherpa_down[k])*2
#        sherpa_up_=(sherpa_up[k]-1.)*2+1.
        sherpa_down_=(sherpa_down[k]-1.)*3.+1.
        sherpa_up_=1.-(1.-sherpa_up[k])*3.
        scale_down_=1.-(1.-scale_down[k])*3.
        scale_up_=(scale_up[k]-1.)*3.+1.
    else:
