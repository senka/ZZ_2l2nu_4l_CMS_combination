...
lumi_7TeV       \t    lnN \t    1.022             """
    ...
    if (codename=="ch7" or codename=="ch8" or codename=="ch9" or codename=="ch10"):
        sherpa_down_=1.-(1.-sherpa_down[k])*0.25
        sherpa_up_=(sherpa_up[k]-1.)*0.25+1.
        scale_down_=1.-(1.-scale_down[k])*0.25
        scale_up_=(scale_up[k]-1.)*0.25+1.
    else:
